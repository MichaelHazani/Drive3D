...
gulp.task('scripts-deploy', function() {
    //this is where our dev JS scripts are
    return gulp.src(['app/scripts/src/app.js', 'app/scripts/src/utils.js', 'app/scripts/src/min/three.min.js', 'app/scripts/src/min/TweenMax.min.js', 'app/scripts/src/FirstPersonControls.js', 'app/scripts/src/ColladaLoader.js', 'app/scripts/src/DeviceOrientationControls.js', 'app/scripts/src/StereoEffect.js', 'app/scripts/src/drive3dnonrecur.js'])
        //prevent pipe breaking caused by errors from gulp plugins
        .pipe(plumber())
        //this is the filename of the compressed version of our JS
        .pipe(concat('app.js'))
